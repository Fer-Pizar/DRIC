...
use App\Http\Controllers\Admin\HomeTestimonialContentController;
use App\Http\Controllers\Admin\InternationalizationContentController;
...
Route::put('pages/{page}/home-testimonials', [HomeTestimonialContentController::class, 'update'])->name('home-testimonials.update');
...
Route::get('pages/{page}/internationalization-content', [InternationalizationContentController::class, 'edit'])->name('pages.internationalization.edit');
Route::put('pages/{page}/internationalization-content', [InternationalizationContentController::class, 'update'])->name('pages.internationalization.update');
