  ...
  return (
    <section className="relative isolate min-h-[92vh] overflow-hidden bg-[#020617] px-4 pb-24 pt-28 text-white md:px-8 md:pb-32 md:pt-36 lg:px-12">
      ...
      <div className="mx-auto flex min-h-[72vh] max-w-6xl flex-col items-center justify-center text-center">
        <Link
          href={primaryHref}
          className="mb-7 inline-flex items-center gap-2 rounded-full border border-white/15 bg-black/35 px-5 py-2 text-xs font-semibold uppercase tracking-[0.22em] text-white/90 shadow-[0_0_30px_rgba(255,255,255,0.12)] backdrop-blur-md"
        >
        ...
        <p className="mt-8 max-w-3xl text-sm leading-relaxed text-white/75 md:text-base lg:text-lg">
        ...
        <div className="mt-10 flex flex-col items-center justify-center gap-4 sm:flex-row">
          ...
          <Link
            href={secondaryHref}
            className="rounded-xl border border-white/15 bg-black/35 px-8 py-3 text-sm font-semibold text-white shadow-[0_0_24px_rgba(255,255,255,0.10)] backdrop-blur-md transition hover:-translate-y-0.5 hover:bg-white/10"
          >
            {secondaryLabel}
          </Link>
        </div>
