...
export default function StatsSection({ section }: Props) {
  return (
    <section className="relative px-6 py-20 md:px-10 lg:px-16">
      <div className="mx-auto max-w-6xl rounded-[32px] border border-white/10 bg-blue-950/40 px-6 py-10 shadow-[0_0_80px_rgba(0,55,112,0.25)] backdrop-blur-xl md:px-10">
